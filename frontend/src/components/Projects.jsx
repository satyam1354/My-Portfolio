            ...
            <div className="m-6">
                ...
                <div className="flex justify-center m-h-40 p-5 gap-8">
                    <div className="border-2 border-gray-400 bg-gray-200 rounded-xl p-2  shadow-md w-60">
                        ...
                        <div className="text-xl text-center mt-2">Project 1</div>
                        <div className="flex gap-2 justify-center mt-2">
                            <div className="border-2 border-black px-2 rounded-lg"><a href="#">GitHub</a></div>
                            <div className="border-2 border-black px-1 rounded-lg"><a href="#">Live Demo</a></div>
                        </div>
                    </div>
                    <div className="border-2 border-gray-400 bg-gray-200 rounded-xl p-2  shadow-md w-60">
                        <div className="py-3 px-1 ">
